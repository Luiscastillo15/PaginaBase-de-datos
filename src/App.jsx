function App() {
  return (
    <>
      ...
      <section className="text-gray-600 body-font bg-slate-600" id="tema2">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h2 className="consola text-center font-semibold mb-8 text-xl text-gray-900 tracking-widest font-mono">
      ...
      <section className="text-gray-600 body-font" id="tema3">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h2 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 font-mono">
              Manejadores o Gestor de Base de Datos (SGBD):
            </h2>
            <p className="mb-8 leading-relaxed text-justify text-slate-900">
      ...
      <section className="text-gray-600 bg-slate-300 body-font" id="tema4-5">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 lg:w-1/2 md:w-full">
              <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
                <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left gap-5">
                  <img
                    alt="team"
                    className="flex-shrink-0 rounded-lg w-48 h-48 object-contain object-center sm:mb-0 mb-4"
      ...
      <section
        className="text-gray-600 bg-slate-100 body-font overflow-hidden"
        id="tema6"
      >
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              <h2 className="text-gray-900 text-3xl title-font font-medium mb-4 font-mono">
                Atributos:
              </h2>
              <p className="leading-relaxed mb-4 text-justify text-gray-800">
      ...
      <section className="text-black  bg-slate-600 body-font" id="tema7">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 font-mono">
              Cardinalidad
            </h1>
          ...
          <div className="flex flex-wrap">
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
              <h2 className="text-lg sm:text-2xl text-gray-900 font-medium title-font mb-2 font-mono">
                Uno a uno (1:1):
              </h2>
              <p className="leading-relaxed text-base mb-4 text-white text-justify">
